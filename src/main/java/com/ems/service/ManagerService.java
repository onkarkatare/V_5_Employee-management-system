...
public interface ManagerService {
	...
	ResponseEntity<String> getLeavesUnderManager(int managerId);
	
	ResponseEntity<String> approveLeave(int applicationId);
	
	ResponseEntity<String> rejectLeave(int applicationId);
}
