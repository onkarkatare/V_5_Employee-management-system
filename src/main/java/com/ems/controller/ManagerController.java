...
public class ManagerController {
	...
	@GetMapping("/api/manager/checkLeaves/{mId}")
	public ResponseEntity<String> getLeavesUnderManager(@PathVariable("mId") int managerId)
	{
		return managerService.getLeavesUnderManager(managerId);
	}
	
	@PostMapping("/api/manager/approveLeave/{aId}")
	public ResponseEntity<String> approveLeave(@PathVariable("aId") int applicationId) 
	{
		return managerService.approveLeave(applicationId);
	}
	
	@PostMapping("/api/manager/rejectLeave/{aId}")
	public ResponseEntity<String> rejectLeave(@PathVariable("aId") int applicationId)
	{
		return managerService.rejectLeave(applicationId);
	}
}
